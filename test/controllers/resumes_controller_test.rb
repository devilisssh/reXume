...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { email: @resume.email, name: @resume.name, phone: @resume.phone, summary: @resume.summary }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { email: @resume.email, name: @resume.name, phone: @resume.phone, summary: @resume.summary }
    assert_redirected_to resume_path(assigns(:resume))
  end
